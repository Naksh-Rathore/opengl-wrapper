...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        glUniform3fv(glGetUniformLocation(cubeShader.shaderProgram(), "light.pos"), 1, glm::value_ptr(lightPos));
        ...
        glUniform3fv(glGetUniformLocation(cubeShader.shaderProgram(), "material.diffuse"), 1, glm::value_ptr(glm::vec3(1.0f, 0.5f, 0.31f)));
        glUniform3fv(glGetUniformLocation(cubeShader.shaderProgram(), "material.ambient"), 1, glm::value_ptr(glm::vec3(1.0f, 0.5f, 0.31f)));
        glUniform3fv(glGetUniformLocation(cubeShader.shaderProgram(), "material.specular"), 1, glm::value_ptr(glm::vec3(0.5f)));
