...
int main() {
 ...
 float vertices[] = {
    ...
    diffuseMap.link("assets/textures/box.png" , GL_REPEAT, GL_LINEAR, GL_LINEAR_MIPMAP_LINEAR);
    specularMap.link("assets/textures/box_specular.png" , GL_REPEAT, GL_LINEAR, GL_LINEAR_MIPMAP_LINEAR);
