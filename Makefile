...
CXXFLAGS := -std=c++23 -Wall -Wextra -O2 \
    -I C:/Users/naksh/glad/include \
    -I C:/Users/naksh/glfw-3.4.bin.WIN64/glfw-3.4.bin.WIN64/include \
    -I include/

LDFLAGS := -L C:/Users/naksh/glfw-3.4.bin.WIN64/glfw-3.4.bin.WIN64/lib-mingw-w64 -lglfw3 -lgdi32 -lopengl32

# ONLY compile files in src/
ifeq ($(OS),Windows_NT)
    SRCS := $(shell powershell -Command "Get-ChildItem src -Recurse -Filter *.cpp | ForEach-Object { $$_.FullName }") \
            C:/Users/naksh/glad/src/glad.c
    RM := powershell -Command "Get-ChildItem -Recurse -Include *.o | Remove-Item -ErrorAction SilentlyContinue"
else
    SRCS := $(shell find src -name "*.cpp") C:/Users/naksh/glad/src/glad.c
    RM := rm -f *.o
endif
